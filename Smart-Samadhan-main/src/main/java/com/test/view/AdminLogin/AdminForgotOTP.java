...
public class AdminForgotOTP {
    ...
    static {
        try {
            Font.loadFont(AdminForgotOTP.class.getResourceAsStream("/assets/fonts/Poppins-Regular.ttf"), 10);
            Font.loadFont(AdminForgotOTP.class.getResourceAsStream("/assets/fonts/Poppins-Bold.ttf"), 10);
        } catch (Exception e) {
    ...
    public VBox createForgotOTP(Runnable backAction) {
        ...
        Button backLogInPage = new Button("Back To Log In");
        backLogInPage.setFont(Font.font(FONT_FAMILY, FontWeight.BOLD, 16));
        backLogInPage.setStyle("-fx-background-color: #007bff;-fx-text-fill:white; -fx-background-radius : 30");
